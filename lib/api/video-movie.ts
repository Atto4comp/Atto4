...
function getMovieProviders() {
  const providers = [
    process.env.NEXT_PUBLIC_MOVIE_EMBED_1 || "https://fed-movies.pstream.mov/tmdb-movie-${id}?logo=false&tips=false&theme=noir&allinone=true&&backlink=https://atto4.pro/#",
  ...
  return providers.length > 0 ? providers : ["https://fed-movies.pstream.mov/tmdb-movie-${id}?logo=false&tips=false&theme=noir&allinone=true&&backlink=https://atto4.pro/#"];
}
