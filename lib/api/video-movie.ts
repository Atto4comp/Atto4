...
function getMovieProviders() {
  const providers = [
    process.env.NEXT_PUBLIC_MOVIE_EMBED_1 || "https://vidora.su/movie/${id}?autoplay=true&colour=219ebc&autonextepisode=true",
  ...
  return providers.length > 0 ? providers : ["https://vidora.su/movie/${id}?autoplay=true&colour=219ebc&autonextepisode=true"];
}
