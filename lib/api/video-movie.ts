...
function getMovieProviders() {
  const providers = [
    process.env.NEXT_PUBLIC_MOVIE_EMBED_1 || "https://cinemaos.tech/player/${id}?logo=false&tips=false&theme=noir&allinone=true&&backlink=https://atto4.pro/#",
  ...
  return providers.length > 0 ? providers : ["https://cinemaos.tech/player/${id}?logo=false&tips=false&theme=noir&allinone=true&&backlink=https://atto4.pro/#"];
}
