    ...
    return (
      <div className="min-h-screen bg-[#050505] pb-20">
        ...
        <div className="relative z-10 flex flex-col items-center px-6 pt-24">
          ...
          <div className="relative w-[200px] aspect-[2/3] rounded-2xl overflow-hidden shadow-2xl border border-white/10 mb-8 transform">
    ...
    <div className="relative min-h-screen bg-[#050505] text-white pt-20">
      ...
      <div className="fixed inset-0 h-screen w-full -z-10">
        <Image 
          ...
          priority 
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#050505] via-[#050505]/90 to-[#050505]/50" />
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-8 md:px-16 pt-8 flex gap-12 items-start min-h-screen pb-20">
        ...
        {/* Right: Info & Actions */}
        {/* ✅ FIX: min-w-0 prevents the flex child from overflowing the viewport */}
        <div className="flex-1 pb-20 min-w-0">
          ...
          {genres && genres.length > 0 && (
            <div className="flex flex-wrap gap-3 mb-12">
              {genres.slice(0, 5).map(g => (
                <span key={g.id} className="text-sm text-gray-400 hover:text-white transition-colors cursor-pointer border-b border-transparent hover:border-white">
                  #{g.name}
                </span>
              ))}
            </div>
          ...
          {/* Cast List - Constrained container */}
