...
export default function MediaCard({
  ...
  return (
    <div className="relative w-48 cursor-pointer" onClick={navigateToDetails} onTouchEnd={router.push(`/${mediaType}/${media.id}`)} tabIndex={0}
      onKeyDown={(e) => { if (e.key === 'Enter') router.push(`/${mediaType}/${media.id}`); }} role="button" tabIndex={0}>
      {/* Poster */}
