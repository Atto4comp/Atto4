...
"[project]/app/hooks/useVideoUrlSwitcher.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useVideoUrlSwitcher(sources) {
    ...
    const switchToNext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (hasNext) {
            setCurrentIndex((prev)=>{
                const nextIndex = prev + 1;
                console.log(`🔄 Switching to source ${nextIndex + 1}/${sources.length}: ${sources[nextIndex]?.provider}`);
                return nextIndex;
            });
        } else {
    ...
    const switchToPrevious = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (hasPrevious) {
            setCurrentIndex((prev)=>{
                const prevIndex = prev - 1;
                console.log(`🔄 Switching back to source ${prevIndex + 1}/${sources.length}: ${sources[prevIndex]?.provider}`);
                return prevIndex;
            });
        }
    }, [
    ...
    const switchToIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((index)=>{
        if (index >= 0 && index < sources.length) {
            console.log(`🔄 Switching to source ${index + 1}/${sources.length}: ${sources[index]?.provider}`);
            setCurrentIndex(index);
        }
    }, [
        sources
    ]);
    const getWorkingSources = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        return sources.filter((source)=>source.working !== false);
    }, [
        sources
    ]);
    const getFailedSources = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        return sources.filter((source)=>source.working === false);
    }, [
        sources
    ]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useVideoUrlSwitcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/hooks/useVideoUrlSwitcher.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function VideoPlayer({ mediaId, mediaType, season, episode, title, onClose }) {
    ...
    const { currentSource, currentIndex, totalSources, hasNext, switchToNext, workingCount, failedCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useVideoUrlSwitcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useVideoUrlSwitcher"])(sources);
    // clear watchdog
...
//# sourceMappingURL=_21eb1249._.js.map