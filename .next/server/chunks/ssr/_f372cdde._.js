...
/** Read env and trim. Allow either base URLs or URL templates. */ const ENV = {
    ...
    E1: (process.env.NEXT_PUBLIC_VIDEO_EMBED_1 || "https://111movies.com/${type}/${id}?autoplay=1&theme=23ddc36c&autoNext=1").trim(),
...
function VideoPlayer({ mediaId, mediaType, season, episode, onClose }) {
    ...
    // Switch to next source if error
...
//# sourceMappingURL=_f372cdde._.js.map