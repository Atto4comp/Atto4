...
"[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
async function getMovieSources(tmdbId) {
    ...
    try {
        const sources = providers.map((provider)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createVideoSource"])(provider, "movie", tmdbId, undefined, undefined, {
                title: `Movie ${tmdbId}`
            }));
...
async function getMovieWithEmbed(tmdbId, testUrls = true) {
    const resolvedTmdbId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveTmdbId"])(tmdbId, 'movie');
    if (!resolvedTmdbId) {
        throw new Error(`Invalid or unresolvable movie TMDB ID: ${tmdbId}`);
    }
    try {
        const [movieResponse, sourcesData] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ENV"].TMDB_API_KEY ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`https://api.themoviedb.org/3/movie/${resolvedTmdbId}`, {
                params: {
                ...
                console.warn(`Failed to fetch movie metadata for ${resolvedTmdbId}:`, error.message);
                return {
                    data: null
                };
            }) : Promise.resolve({
            ...
            getMovieSourcesWithTesting(resolvedTmdbId, testUrls)
        ]);
        ...
        console.log(`🎬 Movie data prepared:`, {
            title: movie?.title || `Movie ${resolvedTmdbId}`,
        ...
        console.error(`Error fetching movie with embed for TMDB ID ${resolvedTmdbId}:`, error);
        return {
            movie: null,
            embedUrl: "",
            sources: [],
...
function getMovieEmbedCandidates(tmdbId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEmbedUrlCandidates"])('movie', tmdbId);
}
function hasMovieSourcesConfigured() {
    return getMovieProviders().length > 0;
}
function getMovieConfigStatus() {
    const providers = getMovieProviders();
...
function debugMovieApi(tmdbId) {
    console.group('🎬 Movie Video API Debug');
    const config = getMovieConfigStatus();
    console.log('Configuration:', config);
    if (tmdbId) {
        try {
            const candidates = getMovieEmbedCandidates(tmdbId);
            console.log(`Embed URL candidates for movie ${tmdbId}:`, candidates);
        } catch (error) {
...
const movieVideoApi = {
    ...
    hasMovieSourcesConfigured,
    getMovieConfigStatus,
    debugMovieApi,
    resolveMovieTmdbId
};
const __TURBOPACK__default__export__ = movieVideoApi;
}),
"[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <locals>");
}),
...
/**
 * Unified Video API shim
 *
 * - Re-exports the modular APIs so existing imports still work
 * - Provides a legacy `videoApi` object that proxies to movie/tv modules
 * - Default export is the legacy `videoApi` object (backwards compatible)
 */ /* Re-export core utilities, types, helpers */ __turbopack_context__.s({
    "default": ()=>__TURBOPACK__default__export__,
    "videoApi": ()=>videoApi
});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-ssr] (ecmascript)");
/* Re-export movie and tv specific modules */ var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <module evaluation>");
...
/* Import the movie and tv modules to build a legacy shim */ var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-tv.ts [app-ssr] (ecmascript) <locals>");
;
;
;
...
;
const videoApi = {
    /* Movie methods */ async getMovieSources (tmdbId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieSources(tmdbId);
    },
    async getMovieWithEmbed (tmdbId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieWithEmbed(tmdbId);
    },
    async getMovieSourcesWithTesting (tmdbId, testUrls = true) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieSourcesWithTesting(tmdbId, testUrls);
    },
    /* TV methods */ async getTVSources (tmdbId, season, episode) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVSources(tmdbId, season, episode);
    },
    async getTVShowWithEmbed (tmdbId, season, episode) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVShowWithEmbed(tmdbId, season, episode);
    },
    async getTVSourcesWithTesting (tmdbId, season, episode, testUrls = true) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVSourcesWithTesting(tmdbId, season, episode, testUrls);
    },
    /* Common utilities */ hasConfiguredApis () {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VIDEO_PROVIDERS"].length > 0;
    },
    getConfigStatus () {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getConfigurationStatus"])();
    },
    getEmbedUrlCandidates (mediaType, tmdbId, season, episode) {
        if (mediaType === 'movie') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieEmbedCandidates(tmdbId);
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVEmbedCandidates(tmdbId, season, episode);
        }
    },
    logConfiguration () {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logConfiguration"])();
    },
    /* Expose sub-APIs */ movie: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"],
    tv: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"]
};
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-tv.ts [app-ssr] (ecmascript) <module evaluation>");
...
//# sourceMappingURL=_56eec20d._.js.map