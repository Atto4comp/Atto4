            ...
            const fetchResults = {
                "SearchPage.useEffect.fetchResults": async ()=>{
                    ...
                    try {
                        ...
                        const res = await fetch("/api/tmdb/search?q=".concat(encodeURIComponent(query)));
                        if (!res.ok) throw new Error("API error: ".concat(res.status));
                        const data = await res.json();
                        if (data === null || data === void 0 ? void 0 : data.results) {
                            // Filter and sort results
                            const filtered = data.results.filter({
                                "SearchPage.useEffect.fetchResults.filtered": (item)=>(item.media_type === 'movie' || item.media_type === 'tv') && item.poster_path && item.popularity > 0
                            }["SearchPage.useEffect.fetchResults.filtered"]).sort({
                                "SearchPage.useEffect.fetchResults.filtered": (a, b)=>(b.popularity || 0) - (a.popularity || 0)
                            }["SearchPage.useEffect.fetchResults.filtered"]);
                            setResults(filtered);
                        } else {
                            setResults([]);
                        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: [
                        ...
                        query && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                query,
                                '" ',
                                !loading && results.length > 0 && "(".concat(results.length, ")")
                            ]
                        }, void 0, true, {
                            fileName: "[project]/app/search/page.tsx",
                            lineNumber: 76,
                ...
                !loading && !error && results.length === 0 && query && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                !loading && !error && results.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: results.map((item)=>{
                        ...
                        }, "".concat(item.media_type, "-").concat(item.id), true, {
                            fileName: "[project]/app/search/page.tsx",
                            lineNumber: 128,
                            columnNumber: 17
                        }, this);
...
_s(SearchPage, "3rvojSP2JhtSj/eSNxNOnqRCE20=", false, function() {
    return [
...
//# sourceMappingURL=_f272c5fb._.js.map