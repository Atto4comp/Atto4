...
"[project]/lib/api/video-movie.ts [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
async function getMovieSources(tmdbId) {
    ...
    try {
        const sources = providers.map((provider)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createVideoSource"])(provider, "movie", tmdbId, undefined, undefined, {
...
async function getMovieWithEmbed(tmdbId) {
    let testUrls = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
    const resolvedTmdbId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveTmdbId"])(tmdbId, 'movie');
    if (!resolvedTmdbId) {
        throw new Error("Invalid or unresolvable movie TMDB ID: ".concat(tmdbId));
    }
    try {
        var _workingSources_, _sources_;
        const [movieResponse, sourcesData] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENV"].TMDB_API_KEY ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("https://api.themoviedb.org/3/movie/".concat(resolvedTmdbId), {
                params: {
                ...
                console.warn("Failed to fetch movie metadata for ".concat(resolvedTmdbId, ":"), error.message);
                return {
                    data: null
                };
            }) : Promise.resolve({
        ...
        const movie = movieResponse === null || movieResponse === void 0 ? void 0 : movieResponse.data;
        ...
        const result = {
            ...
            metadata: {
                ...
                releaseDate: movie === null || movie === void 0 ? void 0 : movie.release_date,
        ...
        console.log("🎬 Movie data prepared:", {
            title: (movie === null || movie === void 0 ? void 0 : movie.title) || "Movie ".concat(resolvedTmdbId),
        ...
        console.error("Error fetching movie with embed for TMDB ID ".concat(resolvedTmdbId, ":"), error);
        return {
            movie: null,
            embedUrl: "",
            sources: [],
...
function getMovieEmbedCandidates(tmdbId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEmbedUrlCandidates"])('movie', tmdbId);
}
...
function debugMovieApi(tmdbId) {
    ...
    if (tmdbId) {
        try {
            ...
            console.log("Embed URL candidates for movie ".concat(tmdbId, ":"), candidates);
        } catch (error) {
...
"[project]/lib/api/video-movie.ts [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-client] (ecmascript) <locals>");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-client] (ecmascript)");
/* Re-export movie and tv specific modules */ var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-client] (ecmascript) <module evaluation>");
...
/* Import the movie and tv modules to build a legacy shim */ var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/api/video-tv.ts [app-client] (ecmascript) <locals>");
;
;
;
...
const videoApi = {
    /* Movie methods */ async getMovieSources (tmdbId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieSources(tmdbId);
    },
    async getMovieWithEmbed (tmdbId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieWithEmbed(tmdbId);
    },
    async getMovieSourcesWithTesting (tmdbId) {
        let testUrls = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieSourcesWithTesting(tmdbId, testUrls);
    },
    /* TV methods */ async getTVSources (tmdbId, season, episode) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVSources(tmdbId, season, episode);
    },
    async getTVShowWithEmbed (tmdbId, season, episode) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVShowWithEmbed(tmdbId, season, episode);
    },
    async getTVSourcesWithTesting (tmdbId, season, episode) {
        let testUrls = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVSourcesWithTesting(tmdbId, season, episode, testUrls);
    },
    ...
    getEmbedUrlCandidates (mediaType, tmdbId, season, episode) {
        if (mediaType === 'movie') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"].getMovieEmbedCandidates(tmdbId);
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"].getTVEmbedCandidates(tmdbId, season, episode);
        }
    },
    logConfiguration () {
    ...
    /* Expose sub-APIs */ movie: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["movieVideoApi"],
    tv: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tvVideoApi"]
};
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$common$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/video-common.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$movie$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-movie.ts [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$tv$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/lib/api/video-tv.ts [app-client] (ecmascript) <module evaluation>");
...
//# sourceMappingURL=_4cb9871e._.js.map