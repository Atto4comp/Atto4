...
const VIDEO_APIS = [
    {
        name: 'VidSrc',
        baseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_EMBED_1 || 'https://vidsrc.to/embed/movie/${id}',
        priority: 1,
        supportsTv: true,
        supportsMovies: true
    },
    {
        name: 'VidSrc Pro',
        baseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_EMBED_2 || '',
        priority: 2,
        supportsTv: true,
        supportsMovies: true
    },
    {
        name: 'Embed Movies',
        baseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_EMBED_3 || '',
        priority: 3,
        supportsTv: true,
        supportsMovies: true
    },
    {
        name: 'SuperEmbed',
        baseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VIDEO_EMBED_4 || '',
        priority: 4,
        supportsTv: true,
        supportsMovies: true
    }
...
function processVideoUrl(api, mediaType, tmdbId, season, episode) {
    ...
    switch(mediaType){
        case 'movie':
            ...
            if (api.name === 'VidSrc') {
                return "".concat(baseUrl, "/movie/").concat(tmdbId);
            } else if (api.name === 'VidSrc Pro') {
                return "".concat(baseUrl, "/movie?tmdb=").concat(tmdbId);
            } else if (api.name === 'Embed Movies') {
                return "".concat(baseUrl, "/embed/movie/").concat(tmdbId);
            } else {
                return "".concat(baseUrl, "/movie/").concat(tmdbId);
            }
        case 'tv':
            ...
            if (api.name === 'VidSrc') {
                return "".concat(baseUrl, "/tv/").concat(tmdbId, "/").concat(season, "/").concat(episode);
            } else if (api.name === 'VidSrc Pro') {
                return "".concat(baseUrl, "/tv?tmdb=").concat(tmdbId, "&season=").concat(season, "&episode=").concat(episode);
            } else if (api.name === 'Embed Movies') {
                return "".concat(baseUrl, "/embed/tv/").concat(tmdbId, "/").concat(season, "/").concat(episode);
            } else {
                return "".concat(baseUrl, "/tv/").concat(tmdbId, "/").concat(season, "/").concat(episode);
            }
        default:
...
async function testVideoSource(source) {
    try {
        ...
        console.warn("Source ".concat(source.servers, " failed test:"), error);
        return false;
    }
}
const videoApi = {
...
function VideoPlayer(param) {
    ...
    const loadVideoSources = async ()=>{
        ...
        try {
            let sources = [];
            if (mediaType === 'movie') {
                sources = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["videoApi"].getAllMovieSources(mediaId);
            } else if (mediaType === 'tv' && season !== undefined && episode !== undefined) {
                sources = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["videoApi"].getAllTVSources(mediaId, season, episode);
            }
            if (sources.length === 0) {
                throw new Error('No video sources configured');
            }
    ...
    const handleIframeError = ()=>{
        var _videoSources_currentSourceIndex;
        console.error("Source ".concat((_videoSources_currentSourceIndex = videoSources[currentSourceIndex]) === null || _videoSources_currentSourceIndex === void 0 ? void 0 : _videoSources_currentSourceIndex.servers, " failed to load"));
    ...
    const getCurrentSource = ()=>{
        return videoSources[currentSourceIndex] || null;
    };
    const currentSource = getCurrentSource();
    const videoUrl = currentSource === null || currentSource === void 0 ? void 0 : currentSource.url;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            videoSources.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: ()=>setShowSourceSelector(!showSourceSelector),
                className: "absolute top-4 right-16 z-20 bg-black/50 hover:bg-black/70 text-white p-2 rounded-full transition-colors",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    currentSource && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            videoSources.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: [
                                    "Source ",
            ...
            showSourceSelector && videoSources.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-2",
                        children: videoSources.map((source, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>{
                                    switchSource(index);
                                    setShowSourceSelector(false);
                                },
                                className: "w-full text-left px-3 py-2 rounded text-sm transition-colors ".concat(index === currentSourceIndex ? 'bg-blue-600 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            error && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            currentSourceIndex < videoSources.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "flex items-center gap-2 bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded-full transition-colors",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rotate$2d$ccw$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__RotateCcw$3e$__["RotateCcw"], {
                                        className: "w-4 h-4"
                                    }, void 0, false, {
            ...
            videoUrl && !loading && !error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative w-full h-full",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                    ref: iframeRef,
                    src: videoUrl,
                    title: "Watch ".concat(title),
            ...
            !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$video$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["videoApi"].hasConfiguredApis() && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(VideoPlayer, "jG5+hu0BjDl2oHxb635SY8KZfkM=");
_c = VideoPlayer;
var _c;
...
function WatchPage() {
    ...
    const mediaId = parseInt(params === null || params === void 0 ? void 0 : params.id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
    ...
    const loadMediaDetails = async ()=>{
        try {
            let data;
            if (mediaType === 'movie') {
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getMovieDetails(mediaId);
            } else {
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVShowDetails(mediaId);
            }
            setMedia(data);
        } catch (error) {
...
_s(WatchPage, "ikattqJLMth+EnrQmXMZUHJhPS4=", false, function() {
    return [
...
//# sourceMappingURL=_72281f43._.js.map