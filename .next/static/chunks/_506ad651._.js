...
"[project]/app/browse/[category]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function BrowsePage() {
    ...
    const defaultMediaType = urlMediaType || ([
        'on-the-air',
        'airing-today'
    ].includes(category) ? 'tv' : 'movie');
    const [mediaType, setMediaType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultMediaType);
    const [genreId, setGenreId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const removeDuplicates = (itemsArray)=>{
        ...
        return itemsArray.filter((item)=>{
            const key = "".concat(item.media_type || mediaType, "-").concat(item.id);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrowsePage.useEffect": ()=>{
            const fetchGenres = {
                "BrowsePage.useEffect.fetchGenres": async ()=>{
                    try {
                        const genreData = mediaType === 'movie' ? await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getMovieGenres() : await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVGenres();
                        setGenres(genreData);
                    } catch (error) {
                        setGenres([]);
                    }
                }
            }["BrowsePage.useEffect.fetchGenres"];
            fetchGenres();
        }
    }["BrowsePage.useEffect"], [
        mediaType
    ...
    const fetchTVData = async (category, pageNum, genreId)=>{
        let data;
        switch(category){
            case 'trending':
                const trendingResults = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVTrending('week');
                data = {
                ...
                break;
            case 'popular':
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVByCategory('popular', pageNum);
                break;
            case 'top-rated':
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVByCategory('top-rated', pageNum);
                break;
            case 'on-the-air':
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVByCategory('on-the-air', pageNum);
                break;
            case 'airing-today':
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTVByCategory('airing-today', pageNum);
                break;
            case 'latest':
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getLatestReleases('tv', pageNum, genreId);
                break;
            default:
                data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].discoverTVShows({
                    page: pageNum,
                    genreId
                });
        }
    ...
    const getCategoryTitle = (cat, type)=>{
        const titles = {
        ...
        return titles[cat] || cat.split('-').map((word)=>word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
    };
    // Fetch data function with enhanced TV show support
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BrowsePage.useCallback[fetchData]": async function(pageNum) {
            ...
            try {
                ...
                if (mediaType === 'tv') {
                    ...
                    switch(category){
                        case 'trending':
                            const trendingResults = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTrending('week');
                            data = {
                                results: trendingResults,
                                total_pages: 1
                            };
                            break;
                        case 'popular':
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getPopularMovies(pageNum);
                            break;
                        case 'top-rated':
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getTopRatedMovies(pageNum);
                            break;
                        case 'upcoming':
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getUpcomingMovies(pageNum);
                            break;
                        case 'now-playing':
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getNowPlayingMovies(pageNum);
                            break;
                        case 'latest':
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getLatestReleases('movie', pageNum, genreId);
                            break;
                        default:
                            data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$tmdb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tmdbApi"].getPopularMovies(pageNum);
                    }
                ...
                if (data === null || data === void 0 ? void 0 : data.results) {
                    let results = data.results.filter({
                        "BrowsePage.useCallback[fetchData].results": (item)=>item.poster_path && item.popularity > 0
                    }["BrowsePage.useCallback[fetchData].results"]);
                    // Apply sorting
                    switch(sortBy){
                        case 'popularity':
                            results.sort({
                                "BrowsePage.useCallback[fetchData]": (a, b)=>(b.popularity || 0) - (a.popularity || 0)
                            }["BrowsePage.useCallback[fetchData]"]);
                            break;
                        case 'rating':
                            results.sort({
                                "BrowsePage.useCallback[fetchData]": (a, b)=>(b.vote_average || 0) - (a.vote_average || 0)
                            }["BrowsePage.useCallback[fetchData]"]);
                            break;
                        case 'release_date':
                            results.sort({
                                "BrowsePage.useCallback[fetchData]": (a, b)=>{
                    ...
                    if (reset) {
                        ...
                        setItems({
                            "BrowsePage.useCallback[fetchData]": (prev)=>{
                                const combined = [
                                    ...prev,
                                    ...results
                                ];
    ...
    const lastItemRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BrowsePage.useCallback[lastItemRef]": (node)=>{
            if (loading) return;
            if (observer.current) observer.current.disconnect();
            observer.current = new IntersectionObserver({
                "BrowsePage.useCallback[lastItemRef]": (entries)=>{
                    if (entries[0].isIntersecting && hasMore) {
                        setPage({
                            "BrowsePage.useCallback[lastItemRef]": (prevPage)=>prevPage + 1
                        }["BrowsePage.useCallback[lastItemRef]"]);
                    }
                }
            }["BrowsePage.useCallback[lastItemRef]"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowLeft$3e$__["ArrowLeft"], {
                                        ...
                                        fileName: "[project]/app/browse/[category]/page.tsx",
                                        lineNumber: 237,
                                        columnNumber: 15
                                    }, this)
                                }, void 0, false, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                            ...
                                            children: getCategoryTitle(category, mediaType)
                                        }, void 0, false, {
                                            fileName: "[project]/app/browse/[category]/page.tsx",
                                            lineNumber: 240,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                genreId && " in ".concat((_genres_find = genres.find((g)=>g.id === genreId)) === null || _genres_find === void 0 ? void 0 : _genres_find.name)
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/app/browse/[category]/page.tsx",
                                            lineNumber: 243,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "p-2 rounded ".concat(viewMode === 'grid' ? 'bg-blue-600' : 'bg-gray-800', " hover:bg-blue-600 transition-colors"),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "p-2 rounded ".concat(viewMode === 'list' ? 'bg-blue-600' : 'bg-gray-800', " hover:bg-blue-600 transition-colors"),
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex flex-wrap items-center justify-between gap-4 mb-8 p-4 bg-gray-900/50 rounded-lg backdrop-blur-sm",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: items.map((item, index)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/".concat(mediaType, "/").concat(item.id),
                                className: "group block transition-transform duration-300 hover:scale-105",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "relative aspect-[2/3] rounded-lg overflow-hidden bg-gray-800 shadow-lg group-hover:shadow-2xl transition-shadow duration-300",
                                        children: [
                                            ...
                                            item.vote_average > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "absolute top-2 right-2 bg-black/80 backdrop-blur-sm text-white px-2 py-1 rounded text-xs font-medium flex items-center gap-1",
                                                children: [
                        ...
                        }, "".concat(mediaType, "-").concat(item.id), false, {
                            fileName: "[project]/app/browse/[category]/page.tsx",
                            lineNumber: 332,
                            columnNumber: 17
                        }, this);
...
_s(BrowsePage, "wMSWdnjZGvDVzbht0vZ1PnBuEGM=", false, function() {
    return [
...
//# sourceMappingURL=_506ad651._.js.map